...
import features from '../../assets/dataFeatures';
  ...
  render() {
        ...
        <section className={styles.container}>
          ...
          <div className={styles.content}>
            ...
            <ul className={styles.list}>{features.map(item => <FeatureItem key={item.id} icon={item.icon} title={item.title} text={item.text} />)}</ul>
          </div>
